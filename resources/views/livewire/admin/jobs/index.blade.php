...
new class extends Component { 
      ...
      {
         return [
            'Job' => JobPosting::orderBy($this->sortColumn,$this->sortDirection)->paginate($this->perPage),
         ];
      }

      public function addNewJob(){
         $this->redirect("/admin/job-management/create", navigate: true);
      }
   ...
   <div class="flex items-center justify-between">
      ...
      <div>
          <button
              ...
              wire:click='addNewJob'>Add New Job</button>
      </div>
  </div>
   ...
   <div class="mt-2 bg-white border rounded-sm border-stroke shadow-default dark:border-strokedark dark:bg-boxdark">
      <div class="max-w-full overflow-x-auto data-table-common data-table-two">
         <div class="datatable-wrapper datatable-loading no-footer sortable searchable fixed-columns">
            ...
            <div class="p-5">
               {{$Job->links('vendor.livewire.tailwind')}}
            </div>
         </div>
      </div>
   </div>
