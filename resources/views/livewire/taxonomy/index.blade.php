...
new class extends Component { 
      ...
      public function getDetails(Taxonomy $taxonomy){
         $this->form->title = $taxonomy->title;
         $this->editId = $taxonomy->id;
         $this->mode = 'edit';
      }

      public function deleteDetails($taxonomyId){
         taxonomy::where('id',$taxonomyId)->delete();
      }
                  ...
                  <tbody>
                     ...
                     <tr data-index="0">
                        ...
                        <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                           ...
                           <button type="button" class="hover:text-primary" wire:click="getDetails({{$taxonomy->id}})">
                           ...
                           <button class="hover:text-primary" wire:click="deleteDetails({{$taxonomy->id}})">
                              <svg class="fill-current" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
