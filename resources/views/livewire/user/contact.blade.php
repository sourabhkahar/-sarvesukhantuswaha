<div class="">
    ...
    <section class="contact-section section-gapping" data-aos="fade-up" data-aos-duration="1500">
        <div class="container">
            <div class="contact">
                <div class="col">
                    <h2>Form</h2>
                    ...
                    <form action="">
                        ...
                        <div class="col-2">
                            ...
                            <div class="field">
                                ...
                                <input type="email" class="input-field" id="" />
                            </div>
                        </div>
                        <div class="field">
                        ...
                        <div class="field">
                            ...
                            <input type="file" class="input-field" id="" />
                        </div>
                        <div class="field">
                            <label for="">Birth Date <span class="required">*</span></label>
                            <input type="date" class="input-field" id="" />
                        </div>
                ...
                <div class="col">
                    ...
                    <p>G-3, Milan Textile Market <br />Beside kuberji house <br />Near RKT Market <br />Begampura, Nawabwadi <br />Sahara Darwaja, Ring Road</p>
                        ...
                        <li>
                            <a href="">
                                <svg
                                    ...
                                    xmlns:xlink="http://www.w3.org/1999/xlink"
                                >
                                    <path d="M762.4,461.8v-71.6h-52.5v71.6h-76.3v52.5h71.6v71.6h52.5v-71.6H834v-52.5H762.4z" fill="currentColor" />
                                    <path
    ...
    <section class="join-section section-gapping" data-aos="fade-up" data-aos-duration="2000">
